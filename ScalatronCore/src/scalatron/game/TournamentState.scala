...
import scalatron.game.TournamentRoundResult.AggregateResult
...
class TournamentState
{
    ...
    /** we maintain a reference to the most recently computed tournament state.
      ...
      */
    private var mostRecentStateOpt: Option[Any] = None  // was: Simulation.UntypedState
    def updateMostRecentState(mostRecentState: Any) { mostRecentStateOpt = Some(mostRecentState) } // was: Simulation.UntypedState
