...
object ExecutionContextForUntrustedCode {
  ...
  /** Creates an ExecutionContext instance based on a thread pool whose threads are optionally sandboxed via a
    ...
    */
  def create(applicationJarDirectoryPath: String,
    ...
    case class PluginSecurityManager(applicationJarDirectoryPath: String,
                                     applicationOutDirectoryPath: String,
                                     pluginDirectoryPath: String)
          ...
          permission match {
            ...
            case runtimePermission: RuntimePermission =>
              permission.getName match {
                case "accessClassInPackage.sun.reflect" | "createClassLoader" |
...
//                                  return // granted
          ...
          System.err.println(
            s"warning: untrusted code was denied permission: '$permission'")
